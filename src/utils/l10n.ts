...
export const l10n = {
  en: {
    ...
    about: {
      ...
      supportProjectDescription:
        'If you enjoy using OfflineAI, please consider supporting the project by:',
    ...
    feedback: {
      title: 'Send Feedback',
      description:
        'Your voice matters! Tell us how OfflineAI is helping you and what we can do to make it even more useful.',
      shareThoughtsButton: 'Sharing your thoughts',
      useCase: {
        label: 'What are you using OfflineAI for?',
      ...
      usageFrequency: {
        label: 'How often do you use OfflineAI? (Optional)',
        options: {
          daily: 'Daily',
          weekly: 'Weekly',
          monthly: 'Monthly',
    ...
    components: {
      ...
      chatEmptyPlaceholder: {
        ...
        noModelsDescription:
          'Download a model to start chatting with OfflineAI',
    ...
    camera: {
      ...
      permissionMessage: 'OfflineAI needs camera access to analyze images',
    ...
    video: {
      permissionTitle: 'Camera Permission Required',
      permissionMessage: 'OfflineAI needs camera access for video analysis',
      requestingPermission: 'Requesting camera permission...',
      noDevice: 'No camera device found',
      errorTitle: 'Camera Error',
  ...
  ja: {
    ...
    about: {
      ...
      supportProjectDescription:
        'OfflineAI をご利用いただき楽しんでいただけているなら、以下の方法でプロジェクトを応援いただけると幸いです：',
    ...
    feedback: {
      title: 'フィードバックを送信',
      description:
        'ご意見をお聞かせください！OfflineAIの使い心地やより便利にするためのアイデアをお寄せください。',
      shareThoughtsButton: 'ご意見を共有する',
      useCase: {
        label: 'OfflineAI をどのように使っていますか？',
    ...
    components: {
      ...
      chatEmptyPlaceholder: {
        ...
        noModelsDescription:
          'OfflineAIとチャットを始めるにはモデルをダウンロードしてください',
    ...
    camera: {
      ...
      permissionMessage:
        'OfflineAIが画像を分析するにはカメラへのアクセスが必要です',
    ...
    video: {
      permissionTitle: 'カメラ許可が必要',
      permissionMessage:
        'OfflineAIが動画を分析するにはカメラへのアクセスが必要です',
      requestingPermission: 'カメラの許可をリクエスト中...',
      noDevice: 'カメラデバイスが見つかりません',
      errorTitle: 'カメラエラー',
  ...
  zh: {
    ...
    about: {
      ...
      supportProject: '支持项目',
      supportProjectDescription:
        '如果你喜欢使用OfflineAI，请考虑通过以下方式支持项目：',
    ...
    feedback: {
      title: '发送反馈',
      description:
        '你的声音很重要！告诉我们OfflineAI AI如何帮助你以及我们可以做什么来使其更有用',
      shareThoughtsButton: '分享你的想法',
      useCase: {
        label: '你如何使用OfflineAI？',
    ...
    components: {
      ...
      chatEmptyPlaceholder: {
        ...
        noModelsDescription: '需要下载一个模型，才能与OfflineAI开始聊天',
        noModelsButton: '下载模型',
        activateModelTitle: '在你和OfflineAI聊天前，请先激活模型~',
    ...
    camera: {
      ...
      permissionMessage: 'OfflineAI需要访问相机来分析图像',
    ...
    video: {
      permissionTitle: '需要相机权限',
      permissionMessage: 'OfflineAI需要访问相机来分析视频',
      requestingPermission: '请求相机权限...',
      noDevice: '未找到相机设备',
      errorTitle: '相机错误',
      errorMessage: '相机出现错误',
